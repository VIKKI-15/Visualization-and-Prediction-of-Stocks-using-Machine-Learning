...
model.fit(x_train, y_train, epochs=25, batch_size= 32)  #a number of epochs means the number of times the model go thorugh the training set 


#Testing the model accuracy on existing data

#Loading the Test Dataa that the model has never seen before
